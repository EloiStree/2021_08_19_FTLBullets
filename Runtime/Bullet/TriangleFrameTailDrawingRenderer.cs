...
public class TriangleFrameTailDrawingRenderer : MonoBehaviour
{

    public JobCompteExe_BulletResultFromIdToMesh m_jobMesh;
    public Mesh m_mesh;
    ...
    public void RefreshMesh()
    {
        if (!m_wasInitialized)
            return;
        JobHandle job = m_jobMesh.Schedule<JobCompteExe_BulletResultFromIdToMesh>(m_jobMesh.m_bulletsCount, 64);
        job.Complete();
...
[BurstCompile]
public struct JobCompteExe_BulletResultFromIdToMesh : IJobParallelFor
{
