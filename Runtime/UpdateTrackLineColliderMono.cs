...
public class UpdateTrackLineColliderMono : MonoBehaviour, ICapsuleLine
{
    ...
    [Header("Debug")]
    public NativeCapsuleLineRegister.LineRef m_lineRef;


    private void Awake()
    {
        NativeCapsuleLineRegister.ClaimRegister.Claim(out int id);
        NativeCapsuleLineRegister.SharedMemory.GetRegisterLink(id, out m_lineRef);
