...
//public class BulletsRendering_PixelSquareWithJob : AbstractBulletsToRenderListener
//{
//    [Header("To Set")]
//    public int m_width=1024;
//    public int m_height=512;
//    public int m_maxQuad = 10800;
//    public MeshFilter m_meshFilter;
//    public SkinnedMeshRenderer m_skinMeshRenderer;

//    public float m_startDistance=2000;
//    public float m_endDistance=10000;
//    public float m_maxHorizontalAngle=110;
//    public float m_maxVerticalAngle=80;

//    public bool m_useDebugTexture;
...
//        if (!m_jobWasInit) {
//            m_jobWasInit = true;
//            m_job.SetParams(m_startDistance, m_endDistance, m_maxHorizontalAngle, m_maxVerticalAngle);
//        }
...
//        m_currentMesh.name = "Bullet as pixel at far distance";
